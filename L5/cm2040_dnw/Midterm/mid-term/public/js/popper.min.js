...
!(function (e, t) {
		...
		if (null != (r = r ? M(r) : null))
			switch (((i = "y" === r ? "height" : "width"), e)) {
				case "start":
					o[r] =
						Math.floor(o[r]) -
						Math.floor(t[i] / 2 - n[i] / 2);
					break;
				case "end":
					o[r] =
						Math.floor(o[r]) +
						Math.ceil(t[i] / 2 - n[i] / 2);
			}
		return o;
	}
	function D(e) {
	...
	function k(e, n) {
		...
		r = D(
			"number" !=
				typeof (r = void 0 === (r = r.padding) ? 0 : r)
				? r
				: P(r, q)
		);
		...
		if (((e = e.modifiersData.offset), "popper" === i && e)) {
			...
			Object.keys(u).forEach(function (e) {
				var t =
						0 <=
						["right", "bottom"].indexOf(e)
							? 1
							: -1,
					n =
						0 <=
						["top", "bottom"].indexOf(e)
							? "y"
							: "x";
				u[e] += d[n] * t;
			});
			...
			},
			{
				...
				effect: function (e) {
					...
					if (
						...
						if (
							"string" == typeof r &&
							!(r = t.elements.popper.querySelector(
								r
							))
						)
							return;
